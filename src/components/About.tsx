...
export default function About() {
  return (
    <section id="o-nama" className="relative overflow-hidden bg-[#09090b] py-24">
      <div className="container relative mx-auto px-6">
        <div className="flex flex-col items-center gap-16 lg:flex-row">
          <div data-gsap="reveal" data-x="-50" className="relative lg:w-1/2">
          ...
          <div data-gsap="reveal" data-x="50" className="lg:w-1/2">
