            ...
            <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-2xl h-full space-y-8">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a href="https://www.google.com/maps/search/?api=1&query=Hidrokop+-+HP+Auto,+Rijeka" target="_blank" rel="noreferrer" className="text-red-500 text-sm hover:underline mt-2 inline-block">
                    Prikaži na mapi
                  </a>
                </div>
              </div>
          ...
          >
            <form className="bg-zinc-900 border border-zinc-800 p-8 rounded-2xl space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                ...
                <input type="date" id="date" className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-500 transition-colors" />
              </div>

              <div className="space-y-2">
                <label htmlFor="message" className="text-sm font-medium text-zinc-400">Poruka / Opis kvara</label>
                <textarea id="message" rows={4} className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-500 transition-colors resize-none" placeholder="Opišite problem ili ostavite dodatnu napomenu..."></textarea>
              </div>
